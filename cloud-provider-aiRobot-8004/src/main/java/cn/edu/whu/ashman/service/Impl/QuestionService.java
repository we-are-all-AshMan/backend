...
public class QuestionService implements IQuestionService {
    ...
    List<Question> selectAllQuestions(){return questionDao.selectAllQuestions();}

    public void insertQuestion(Question question){questionDao.insertQuestion(question);}

    public void deleteQuestion(Question question){questionDao.deleteQuestion(question);}

    public void updateQuestion(Question question){questionDao.updateSetAskTimeIsZero();}

    public void updateQuestionPlusOne(String question){questionDao.updateSetAskTimePlusOne(question);}
}
